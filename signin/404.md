...
function SigninPage(){
    ...
    if (typeof web3 !== 'undefined') {
        ...
        const infura = 'https://mainnet.infura.io/v3/7f51db571e904b2eb303b14204eeb782';
    ...
    //                    message: "Welcome to BullRun Reburn"
    //                }, {
    //                        type: 'minimalist',
    //                        placement: {
    //                            from: "bottom",
        ...
        try {
            myContractInstance.methods.users(account).call().then(function (result) {
                if (result[0]) {
                    ...
                    location.href = "https://bullrunreburn.github.io/Home-Dashboard";
                }
                else {
            ...
            <div class="wrap-login100">
                <div class="login100-form">
                    <form class="w-100 validate-form" onsubmit="return false" id="signinform">
                        ...
                        <div class="w-100">
                            <img src="https://bullrunreburn.github.io/wallet.png" class="w-100 p-b-34" />
                        </div>
                        ...
                        <p class="m-b-15 text-right text-white">Dont have account ? <a href="https://bullrunreburn.github.io/signup" class="text-white"> Sign up</a></p>
                    ...
                    <a href="https://bullrunreburn.github.io/bullrunonepager.pdf" target="_blank" class="btn btn-lg btn-gradient-blue btn-round btn-glow"><i class="fa fa-file-pdf-o" ></i> &nbsp;  Presentation 1</a>
                </div>
                
                <div class="purchase-token-btn text-center" style="margin-bottom:20px;margin-top:20px;">
                    <a href="https://bullrunreburn.github.io/autopoolworking.pdf" target="_blank" class="btn btn-lg btn-gradient-blue btn-round btn-glow"><i class="fa fa-file-pdf-o" ></i> &nbsp;  Presentation 2</a>
                </div>
                
                <div class="purchase-token-btn text-center" style="margin-bottom:20px;margin-top:20px;">
                    <a href="https://bullrunreburn.github.io/bullrun.pdf" target="_blank" class="btn btn-lg btn-gradient-blue btn-round btn-glow"><i class="fa fa-file-pdf-o" ></i> &nbsp;  Presentation 3</a>
                </div>
                    ...
                    <div class="col-xl-12 col-lg-12 col-md-12 text-center d-flex d-block m-t-10">
                        <div class="row">
                            ...
                            <div class="socialjs col-lg-12 m-t-10">
                                ...
                                <a class="sharebutton telegram btn" target="_blank" style="background-color:#0088cc;color:white" href="https://t.me/BullRunRBChat"><i class="fa fa-telegram"></i> </a>
                ...
                <div class="login100-more ">
                    <div class="col-lg-12 m-t-30">
                        <a href="https://bullrunreburn.github.io"> <img src="https://bullrunreburn.github.io/signup/assets/img/bullrun3.png" style="" class="w-100" /></a>
                    </div>
